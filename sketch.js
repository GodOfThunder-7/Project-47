...
track1 = createSprite(windowWidth/28, -windowHeight*4, 10,windowHeight);
track1.shapeColor = "brown";
track1.velocityY = 5;
track2 = createSprite(windowWidth/10, -windowHeight*4, 10,windowHeight);
track2.shapeColor = "brown";
track2.velocityY = 5;
track3 = createSprite(windowWidth/4.4, -windowHeight*4, 10,windowHeight);
track3.shapeColor = "brown";
track3.velocityY = 5;
track4 = createSprite(windowWidth/3.45, -windowHeight*4, 10,windowHeight);
track4.shapeColor = "brown";
track4.velocityY = 5;
track5 = createSprite(windowWidth/2.35, -windowHeight*4, 10,windowHeight);
track5.shapeColor = "brown";
track5.velocityY = 5;
track6 = createSprite(windowWidth/2, -windowHeight*4, 10,windowHeight);
